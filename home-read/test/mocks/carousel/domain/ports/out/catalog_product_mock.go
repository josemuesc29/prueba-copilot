...
//
//	mockgen -source=catalog_product.go -destination=../../../../../test/mocks/carousel/domain/ports/out/catalog_product_mock.go
//
...
import (
	model "ftd-td-home-read-services/internal/shared/domain/model"
	reflect "reflect"
