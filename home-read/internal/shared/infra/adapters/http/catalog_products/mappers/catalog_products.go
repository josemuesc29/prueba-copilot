...
func CatalogProductsInformationToCarouselProductInformationList(cpsInformation response.CatalogProductsInformation) []model.ProductInformation {
	var rs []model.ProductInformation

	for _, cpInformation := range cpsInformation.Results {
