...
//
//	mockgen -source=best_seller.go -destination=../../../../../test/mocks/offer/domain/ports/out/best_seller_mock.go
//
...
func (m *MockBestSellerOutPort) GetBestSellerDepartment(countryId, departmentId string) (*[]model.BestSellerDepartment, error) {
	m.ctrl.T.Helper()
