...
import com.imaginamos.farmatodo.model.user.UserV2;
...
public class CustomerV2 extends UserV2 {
  ...
  public CustomerV2(int id, String documentNumber, String firstName, String lastName, String gender, String phone, String profileImageUrl) {
    this.setId(id);
