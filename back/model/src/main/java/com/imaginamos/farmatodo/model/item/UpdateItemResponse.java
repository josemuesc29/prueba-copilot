...
public class UpdateItemResponse {
    ...
    public UpdateItemResponse(String status,Integer status_code, String message) {
        this.status = status;
        this.status_code = status_code;
        this.message = message;
    }

    public UpdateItemResponse(String status,Integer status_code, ArrayList<String> messages) {
        this.status = status;
        this.status_code = status_code;
