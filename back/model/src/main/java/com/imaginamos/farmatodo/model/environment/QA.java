...
public class QA extends Enviroment{

	private static QA instance = null;

	private QA() {
		this.ENVIROMENT_NAME           				= "QA";
		this.IP_BASE                   				= "http://130.211.222.115:11103/";
		this.IP_BASE_MONITOR                   		= "http://130.211.222.115:11103/";
		this.BACKEND_CORE_30_HOST_BASE 				= "https://sas-v30-dot-stunning-base-164402.appspot.com/";
//		this.API_GATEWAY 							= "https://gateway-dot-stunning-base-164402.uc.r.appspot.com/";
		this.API_GATEWAY 							= "https://prime2-dot-gateway-dot-stunning-base-164402.uc.r.appspot.com/";
		this.OMS_DIRECT								= "https://prime-dot-oms-dot-stunning-base-164402.uc.r.appspot.com/";
//		this.DTF_DIRECT								= "https://paymentsv2-dot-datafoundation-dot-stunning-base-164402.uc.r.appspot.com/"; // pruebas
		this.DTF_DIRECT								= "https://datafoundation-dot-stunning-base-164402.uc.r.appspot.com/";
//		this.CMS_DIRECT								= "https://cms-dot-stunning-base-164402.appspot.com/";
		this.CMS_DIRECT								= "https://gateway-dot-stunning-base-164402.appspot.com/";
		this.ANTIFRAUD								= "https://antifraud-dot-stunning-base-164402.uc.r.appspot.com/";
		this.NEST_UTILITIES_DIRECT                  = "https://sessionid-dot-utilities-dot-stunning-base-164402.uc.r.appspot.com/";
...
//		this.ALGOLIA_STORE_CONFIG      				= "store_config_dev"; // DEV
		...
		//this.ALGOLIA_PAYMENTMETHODS_DELIVERYTYPE    = "PAYMENTMETHODS.DELIVERYTYPE"; // prod
		//this.ALGOLIA_PAYMENTMETHODS_DELIVERYTYPE    = "PAYMENTMETHODS.DELIVERYTYPE_DEV"; /// dev
		//this.ALGOLIA_PAYMENTMETHODS_DELIVERYTYPE    = "PAYMENTMETHODS.DELIVERYTYPE_V2"; /// v2
		this.ALGOLIA_PAYMENTMETHODS_DELIVERYTYPE    = "PAYMENTMETHODS.DELIVERYTYPE_V2_DEV"; /// v2 DEV
		...
		this.ALGOLIA_OPTIMAL_ROUTE_DISTANCES	    = "OPTIMAL.ROUTE.DISTANCES.CO";		// PROD
...
//		this.ALGOLIA_CREATE_ORDER_CONFIG			= "CREATE.ORDER.CONFIG_DEV"; // DEV
...
//		this.ALGOLIA_PRODUCT_DETAIL                 = "PRODUCT.DETAIL.DEV";
...
//		this.ALGOLIA_HOME_DEAFULT_BANNERS           = "DEFAULT.HOME.BANNERS";
		this.ALGOLIA_HOME_DEAFULT_BANNERS           = "DEFAULT.HOME.BANNERS2";
...
//		this.ALGOLIA_LANDING_PROVIDERS_AND_ACTIVE 	= "LANDING_PROVIDERS_AND_ACTIVE.DEV";
		...
		this.REDIS_DB_IP = "10.89.109.251";
