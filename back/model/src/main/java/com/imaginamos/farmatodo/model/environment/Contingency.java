...
public class Contingency extends Enviroment{

	private static Contingency instance = null;

	private Contingency() {
		this.ENVIROMENT_NAME           				= "CONTINGENCY";
		this.IP_BASE                   				= "http://35.225.86.101:11103/";
		this.IP_BASE_MONITOR                   		= "http://35.225.86.101:11103/";
		this.BACKEND_CORE_30_HOST_BASE 				= "https://sas-v30-dot-stunning-base-164402.appspot.com/";
		this.API_GATEWAY 							= "https://gateway-dot-stunning-base-164402.appspot.com/";
		this.OMS_DIRECT								= "https://oms-dot-stunning-base-164402.appspot.com/";
...
//		this.CMS_DIRECT								= "https://cms-dot-stunning-base-164402.appspot.com/";
		...
		this.NEST_UTILITIES_DIRECT                  = "https://utilities-dot-stunning-base-164402.uc.r.appspot.com/";
...
//		this.ALGOLIA_LANDING_PROVIDERS_AND_ACTIVE 	= "LANDING_PROVIDERS_AND_ACTIVE.DEV";
	...
	public static Contingency getInstance() {
        if (instance == null) {
        	instance = new Contingency();
        }
        return instance;
	}
