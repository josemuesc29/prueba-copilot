...
public class  CollectionResponseModel {
  ...
  private List<DeliveryOrder> activeOrders;
  private List<DeliveryOrder> previousOrders;
  ...
  public void setActiveOrders(List<DeliveryOrder> activeOrders) {
    this.activeOrders = activeOrders;
  }

  public List<DeliveryOrder> getPreviousOrders() {
    return previousOrders;
  }

  public void setPreviousOrders(List<DeliveryOrder> previousOrders) {
