...
import (
	"testing"
	"time"
	// "ftd-td-catalog-item-read-services/internal/products-related/domain/model" // No es necesario si solo probamos el resultado del mapper
...
func TestMapProductInformationToRelatedItem(t *testing.T) {
	// Esta función es más un conversor de tipos, pruebas básicas serían suficientes.
	// Dado que no es el foco principal de la HU, se puede expandir luego.
